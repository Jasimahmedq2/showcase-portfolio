const Footer = () => {
  ...
  return (
    <div className="px-4 pt-16 sm:mt-12 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
      <div className="flex justify-between items-center py-2">
        ...
        <div>
          ...
          <p className="mt-4 text-sm text-gray-200">Connect on Social Media</p>
        </div>
      </div>
      <div className="flex flex-col-reverse justify-between pt-5 pb-10 border-t lg:flex-row">
        <p className="text-sm text-white">
          © Copyright {year} jasim_portfolio. All rights reserved.
        </p>
      </div>
    </div>
  );
